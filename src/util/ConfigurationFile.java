 ...
 * 
 * @author Shachar Levy
 *	The class represents a configuration file for the web crawler.
...
public class ConfigurationFile {
	...
	/**
	 * The duration to run the web crawler process
	 */
	private int durationOfWebCrawler;
	/**
	 * Time units for the execution time of the web crawler
	 */	
	 ...
	 * @param duration - duration of web crawler execution
	...
	/**
	 * returns the time unit of the crawler - default is minutes
	 * @return
	 */
